...
export const navItems = [
  ...
  { href: "/begleitschreiben", label: "Versand" },
  { href: "/laden", label: "Laden" },
  { href: "/kontakt", label: "Kontakt" }
];

export const footerLinks = [
  { href: "/begleitschreiben", label: "Versand & Begleitschreiben" },
  { href: "/faq", label: "FAQ" },
...
export const featureItems = [
  ...
  },
  {
    title: "Ankauf",
    icon: ReceiptText,
    text: "Wir kaufen Antiquitäten, Schmuck, Münzen, Postkarten und dänische Design-Möbel. Auch komplette Sammlungen und Nachlässe sind willkommen."
  },
  {
    title: "Bundesweit",
    icon: Globe2,
    text: "Neben Kappeln und Schleswig-Holstein sind wir bundesweit auf Auktionen in Deutschland, den Niederlanden und Skandinavien unterwegs."
  },
  {
  ...
  },
  {
    title: "Erfahrung",
    icon: BadgeCheck,
    text: "Langjährige Erfahrung im Antikhandel garantiert eine faire, transparente und professionelle Bewertung Ihrer Objekte, in Kappeln, Schleswig-Holstein und bundesweit."
  }
];
...
export const buyItems = [
  ...
  },
  {
    ...
    alt: "Schmuckstücke",
    reverse: true,
    text: "Wir kaufen hauptsächlich antiken Schmuck und Modeschmuck. Auch reparaturbedürftige Stücke kaufen wir gerne an und arbeiten mit erfahrenen Goldschmieden zusammen, um sie fachgerecht wiederherzustellen."
  },
  {
