...
export const buyItems = [
  {
    ...
    accent: "Fotos, Fotoalben und Postkarten",
    image: "/images/foto.jpg",
    alt: "Alte Fotos und Alben",
    text: "Unser Interesse an den Ankauf von Fotos ist vielfältig. Wir kaufen Fotos aus Kriegs- und Friedenszeiten, Kunstfotos, Aktfotos, historische Bilder, Fotos aus den Kolonien und private Sammlungen. Wir schätzen die Einzigartigkeit jedes Fotos und arbeiten mit Museen, Archiven und privaten Sammlern zusammen, um diese Vielfalt zu bewahren."
  },
  {
  ...
  {
    title: "Ankauf von Militaria und Kriegserinnerungen",
    accent: "Militaria und Kriegserinnerungen",
    image: "/images/kriegserinnerung2.jpg",
    alt: "Militaria und Kriegserinnerungen",
    reverse: true,
    text: "Haben Sie Militaria oder Kriegserinnerungen zu verkaufen? Wir kaufen historische militärische Gegenstände, Kriegsandenken und Erinnerungsstücke aus verschiedenen Epochen. Sowie Orden, Uniformen, Fotos, Schwerter, Dolche, Briefe und andere Zeugnisse von Kriegserfahrungen."
  },
   {
    title: "Ankauf von Schreibwaren und Füllfederhaltern",
    accent: "Schreibwaren und Füllfederhaltern",
    image: "/images/fueller1.png",
    alt: "Schreibwaren und Füllfederhalter",
    reverse: true,
    text: "Wir kaufen alte Schreibgeräte aller Art an – darunter Füllfederhalter, Kugelschreiber, Bleistifte, Drehbleistifte sowie weitere historische und moderne Schreibwaren."
  },
  {
    title: "Ankauf von Spielzeug",
    accent: "Spielzeug",
    image: "/images/auto.jpeg",
    alt: "Spielzeug",
    reverse: true,
    text: "Wir kaufen Spielzeug und Sammlerartikel aus allen Epochen an. Dazu gehören modernes Spielzeug, Computerspiele, furbys,  Sammelfiguren, Pokémon-Karten und andere Trading Cards ebenso wie antikes Spielzeug, Märklin-Eisenbahnen, Blechspielzeug, Modellbahnen und seltene Sammlerstücke."
  }
];
